...
class MovieRequest extends FormRequest
{
    ...
    {
        return [
            'name.min' => 'Минимальное количество символов не меньше 2',
            'name.max' => 'Максимальное количество символов не должно привышать 40',
            'name.unique' => 'Название должно быть уникальным',
            'session_duration.regex' => 'Некорректный формат времени',
            'rating.between' => 'Рейтинг должен быть числом и находиться в промежутке от 0 до 10',
            'rating.regex' => 'Рейтинг не может иметь более 2х знаков после запятой',
            'age_limit.int' => 'Может содержать только цифры',
            'age_limit.max' => 'Максимальное возраст не более 21',
            'age_limit.min' => 'Минимальный возраст не меньше 1',
            'description.max' => 'Описание не должно содержать более 1000 символов',
