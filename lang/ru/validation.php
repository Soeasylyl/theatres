...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'phone.max' => 'Номер телефона не может быть длиннее :max символов.',
        ...
        'new_password' => [
            'required' => 'Новый пароль должен содержать минимум 8 символов',
            'regex' => 'Поле :attribute должно содержать как минимум одну маленькую букву, одну заглавную букву и одну цифру.',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'new_password_confirmation' => 'повторение нового пароля',
    ],
];
