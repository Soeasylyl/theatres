                            ...
                            <td>
                                <div class="admin-container__table_last_cell">
                                    ...
                                    <form action="{{ route('screenings.destroy', $screening->id) }}" method="post">
                                        ...
                                        <div class="admin-container__table_last_cell_screenings_trash"
                                             data-screening-start="{{ $screening->start_at }}"
                                             data-theatre-name="{{ $screening->hall->theatre->name }}"
                                             data-hall-name="{{ $screening->hall->name }}"
                                             title="{{ __('Удалить') }}">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="23"
                                                 viewBox="0 0 1024 1024">
                                                <path fill="#000"
